...
/*
 * Code from http://introcs.cs.princeton.edu/java/22library/Gaussian.java.html
 */
...
public class Gaussian {
    ...
    public static double phi(double val, double mean, double stdev) {
        return phi((val - mean) / stdev) / stdev;
    }
